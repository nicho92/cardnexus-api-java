...
class InventoryServiceTests {
	...
	void init() throws IOException
	{
	  ...
	  @Test
    	...
    	{
    	    var iline2 = new InventoryLine(null, null, "test creation", 44269, "mtg", EnumFinishes.Standard, EnumCondition.LP, "en", 1, false, null, null, null, null, "private note", null);
    	    var iline = new InventoryLine(null, null, "test creation", 44269, "mtg", EnumFinishes.Standard, EnumCondition.LP, "fr", 1, false, null, null, null, null, "private note",null); // this product doesn't exist in this language
